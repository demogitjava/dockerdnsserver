 ...
 *
 * @author Steve Beaty
 * @version $Id: Utils.java,v 1.3 2004/07/22 05:13:49 drb80 Exp $
 */
...
public class Utils
{
	...
	if (!assertion)
	{
		...
		System.out.print (" in class " + ste[1].getClassName());
		System.out.print (" from file " + ste[1].getFileName());
		System.out.print (" in method " + ste[1].getMethodName());
		System.out.println (" at line " + ste[1].getLineNumber());
	    }
	}
    }
